...
DROP TABLE gama_producto CASCADE CONSTRAINTS;
...
SELECT * FROM cliente;
SELECT SUBSTR(nombre_cliente,1 ,3) FROM cliente;
SELECT INSTR(nombre_cliente, ' ',INSTR(nombre_cliente, ' '),2) FROM cliente;
SELECT cliente.nombre_cliente, INSTR(nombre_cliente,' '), SUBSTR(nombre_cliente, INSTR(nombre_cliente, ' ') + 1, 29) FROM cliente;
SELECT cliente.nombre_cliente, INSTR(nombre_cliente,' '), SUBSTR(nombre_cliente, INSTR(nombre_cliente, ' ') + 1) FROM cliente;
