...
DECLARE
    ...
    -- 3. Declara una variable numérica (NUMBER) con 3 dígitos que no sea null
    --sin inicializar.
    num1 NUMBER(3) := 199; --No se puede, hay que inicializarla o declararla.
    -- 4. Declara una variable numérica (NUMBER) con 4 dígitos de precisión de
    --los cuales 2 son decimales e inicialízala a 10,99.
    num2 NUMBER(4, 2) := 10.99;
    -- 5. Declara una variable carácter (VARCHAR2) de tamaño 10 con la frase 
    --CLASE DE DAMDAW.
