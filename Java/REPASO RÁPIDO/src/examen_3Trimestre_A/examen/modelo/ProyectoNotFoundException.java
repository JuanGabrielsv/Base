...
public class ProyectoNotFoundException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8244350441691087687L;
	...
	public ProyectoNotFoundException(String message, Throwable cause, boolean enableSuppression,
