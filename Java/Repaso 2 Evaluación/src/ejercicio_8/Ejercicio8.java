...
public class Ejercicio8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(ejercicio_7.Calculadora.sumar(4, 5));
		System.out.println(ejercicio_7.Calculadora.restar(5, 3));
		System.out.println(ejercicio_7.Calculadora.multiplicar(2, 5));
		System.out.println(ejercicio_7.Calculadora.dividir(10, 2));
