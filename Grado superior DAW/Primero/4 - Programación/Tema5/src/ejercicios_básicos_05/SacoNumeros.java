...
public class SacoNumeros {
	...
	// MÉTODOS.
	// La clase SacoNumeros tendrá que tener un método addNumero() que te permita ir
	// añadiendo dichos números.
	...
	// Una vez que lo tengas modificado, añade otro método que sea getNumero() que
	// recibe un
	...
	// método que sea division() que devuelva un BigDecimal con el
	// resultado de dividir el primer número de la lista entre el segundo, y el
	// resultado entre el tercero, y el resultado entre el cuarto, y así
	// sucesivamente
	// hasta terminar la lista.
	// El resultado de cada división parcial estará siempre redondeado a 2 decimales
	// con HALF_UP.	
